...
MainInterface::MainInterface(Visualization* pAgentVisualization, ScalarAgentGridBase* pScalarAgentGrid)
	...
	, _vectorGlyphGrid()
	, _scalarHeightGrid()
	, _scalarHeightColorGrid()
	, _scalarGranulomaGrid()
	, _pAgentsVisualization(pAgentVisualization)
	, _invisibleQuadVisualization(Simulation::_DIM)
	, _smokeVisualization(Simulation::_DIM, &_scalarSmokeNormalizer, &_scalarSmokeGrid)
	, _glyphVisualization(Simulation::_DIM, &_scalarGlyphNormalizer, &_scalarGlyphGrid, &_vectorGlyphGrid)
	, _isolinesVisualization(Simulation::_DIM, &_scalarIsolinesNormalizer, &_scalarSmokeGrid)
	, _heightPlotVisualization(Simulation::_DIM, &_scalarHeightNormalizer, &_scalarHeightColorNormalizer, &_scalarHeightGrid, &_scalarHeightColorGrid,
			new VectorGradientDataset(_pScalarHeightDataset, true))
	, _granulomaVisualization(Simulation::_DIM, &_scalarGranulomaNormalizer, &_scalarGranulomaGrid)
