...
struct ForwardEulerStepper : Stepper
{
  ...
  /*virtual*/ Stepper* clone() const
  {
    return new ForwardEulerStepper(*this);
  }
};
...
struct EulerPCStepper : Stepper
{
  ...
  /*virtual*/ Stepper* clone() const
  {
    return new EulerPCStepper(*this);
  }
};
...
inline Stepper* StepperFactory(ODEMethod method, size_t dim, bool adaptive=false, double eps=1e-5)
{
  ...
  switch(method)
    {
    case FEuler:
      ret = new ForwardEulerStepper(dim);
      break;
    case EulerPC:
      ret = new EulerPCStepper     (dim);
      break;
    case RK2:
      ret = new RK2Stepper         (dim);
      break;
    case RK3:
      ret = new RK3Stepper         (dim);
      break;
    case RK4:
      ret = new RK4Stepper         (dim);
      break;
    case HeunEuler:
      ret = new HEStepper          (dim);
      break;
    case RKCK:
      ret = new RKCKStepper        (dim);
      break;
    case RKF:
      ret = new RKFStepper         (dim);
      break;
    case BogShamp:
      ret = new BSStepper          (dim);
      break;
    default:
...
inline std::ostream& operator<<(std::ostream& s, ODEMethod method)
{
  switch(method)
    ...
    case HeunEuler:
      ...
      break;
    case RKCK:
      s<<"Runge-Kutta Cash-Karp";
      break;
    case RKF:
      s<<"Runge-Kutta Fehlberg";
      break;
    case BogShamp:
      s<<"Bogacki-Shampine";
      break;
