...
const ParamDescription ParamsBase::_description[_PARAM_COUNT] =
{
	...
	{ "kDeg",                               GR_NODE,    false,  false,  0.0,    0,  "1/s",              "TNF degradation rate constant" },
    ...
    { "Ikdeg",                              GR_NODE,    false,  false,  0.0,    0,  "1/s",              "Degredation rate constant for ODE IL10" },
    ...
    { "saturationApoptosisTNF_Molecular",	GR_NODE,	false,	false,	0.0,	0,	"#molecules",		"Signal saturation of number of int-bound TNFR1 Molecules" },
    ...
    { "IC50ChemokineIL10",                  GR_NODE,    false,  false,  0.0,    0,  "#molecules/mL"     "IC50 of IL10 inhibition of chemokine secretion - All chemokines are the same" },
    ...
    { "saturationFracNFkBTNF_Molecular",	MAC_NODE,	true,	false,	0.0,	0,	"fraction",			"Saturation fraction of bound TNFR1 moleculae for NFkB activation" },
    ...
    { "recruitmentHalfSatTNF",				MAC_NODE,	false,	false,	0.0,	0,	"",					"Half-saturation paramter for Mac TNF-dependent recruitment" },
    { "recruitmentHalfSatChemokine",		MAC_NODE,	false,	false,	0.0,	0,	"",					"Half-saturation paramter for Mac chemokine-dependent recruitment" },
    { "maxRecProb",                         MAC_NODE,	true,	false,	0.0,	0,	"",					"Max probability of recruiting a macrophage - Scales recruitment function" },
    { "thresholdRecChemokine",              MAC_NODE,	false,	false,	0.0,	0,	"",					"Threshold of Mac Recruitment for Chemokines" },
    { "thresholdRecTNF",                    MAC_NODE,	false,	false,	0.0,	0,	"",					"Threshold of Mac Recruitment for TNF" },
    { "stat1ActivationTime",                MAC_NODE,	false,	false,	0.0,	0,	"",					"Time a Macrophage is STAT1 Activated" },
    { "nfkbActivationTime",                 MAC_NODE,	false,	false,	0.0,	0,	"",					"Time a Macrophage is NFkB Activated" },
    ...
    { "recruitmentHalfSatTNF",				TGAM_NODE,	false,	false,	0.0,	0,	"",					"Half-saturation paramter for Tcell TNF-dependent recruitment" },
    { "recruitmentHalfSatChemokine",		TGAM_NODE,	false,	false,	0.0,	0,	"",					"Half-saturation paramter for Tcell chemokine-dependent recruitment" },
    { "maxRecProb",                         TGAM_NODE,	true,	false,	0.0,	0,	"",					"Max probability of recruiting a Tgam - Scales recruitment function" },
	...
	{ "rateTGFB",                           TGAM_NODE,	false,	false,	0.0,	0,	"",					"Probability rate of TGF-B Tgam10 activation" },
	{ "rateICOS",                           TGAM_NODE,	false,	false,	0.0,	0,	"",					"Probability rate of ICOS Tgam10 activation" },
	{ "rateAgDegree",                       TGAM_NODE,	false,	false,	0.0,	0,	"",					"Probability rate of 2degree antigen stimulation" },
    { "thresholdRecChemokine",              TGAM_NODE,	false,	false,	0.0,	0,	"",					"Threshold of Tgam Recruitment for Chemokines" },
    { "thresholdRecTNF",                    TGAM_NODE,	false,	false,	0.0,	0,	"",					"Threshold of Tgam Recruitment for TNF" },
    ...
    { "maxRecProb",                         TCYT_NODE,	true,	false,	0.0,	0,	"",					"Max probability of recruiting a Tcyt - Scales recruitment function" },
    { "recruitmentHalfSatTNF",				TCYT_NODE,	false,	false,	0.0,	0,	"",					"Half-saturation paramter for Tcell TNF-dependent recruitment" },
    { "recruitmentHalfSatChemokine",		TCYT_NODE,	false,	false,	0.0,	0,	"",					"Half-saturation paramter for Tcell chemokine-dependent recruitment" },
    { "thresholdRecChemokine",              TCYT_NODE,	false,	false,	0.0,	0,	"",					"Threshold of TCYT Recruitment for Chemokines" },
    { "thresholdRecTNF",                    TCYT_NODE,	false,	false,	0.0,	0,	"",					"Threshold of TCYT Recruitment for TNF" },
    ...
    { "halfSatTregDeactivateIL10",          TREG_NODE,  false,  false,  0.0,    0,  "",                 "Half-saturation of Treg Deactivation - Based on IL10 concentration" },
    { "halfSatTregDeactivateTNF",           TREG_NODE,  false,  false,  0.0,    0,  "",                 "Half-saturation of Treg Deactivation - Based on TNF concentration" },
    { "maxRecProb",                         TREG_NODE,	true,	false,	0.0,	0,	"",					"Max probability of recruiting a Treg - Scales recruitment function" },
    { "recruitmentHalfSatTNF",				TREG_NODE,	false,	false,	0.0,	0,	"",					"Half-saturation paramter for Tcell TNF-dependent recruitment" },
    { "recruitmentHalfSatChemokine",		TREG_NODE,	false,	false,	0.0,	0,	"",					"Half-saturation paramter for Tcell chemokine-dependent recruitment" },
...
bool ParamsBase::checkParams() const
{
	...
	if (getParam(PARAM_TCELL_LYMPH_PROXY_FACTOR_TIME_START) < getParam(PARAM_TCELL_LYMPH_PROXY_SCALING_START))
	{
		std::cerr << " lymphProxyFactorStart, " << getParam(PARAM_TCELL_LYMPH_PROXY_FACTOR_TIME_START) <<
				", is < lymphProxyScalingStart, " << getParam(PARAM_TCELL_LYMPH_PROXY_SCALING_START) << std::endl;
		res = false;
	}

	if (getParam(PARAM_TCELL_LYMPH_PROXY_FACTOR_TIME_END) < getParam(PARAM_TCELL_LYMPH_PROXY_FACTOR_TIME_START))
	{
		std::cerr << " lymphProxyFactorEnd, " << getParam(PARAM_TCELL_LYMPH_PROXY_FACTOR_TIME_END) <<
				", is < lymphProxyFactorStart, " << getParam(PARAM_TCELL_LYMPH_PROXY_FACTOR_TIME_START) << std::endl;
		res = false;
	}
