...
const ParamDescription ParamsBase::_description[_PARAM_COUNT] =
{
	...
	{ "KN",									GR_NODE,	false,	false,	0.0,	0,	"#/cell",			"number of IKKK molecules" },
	{ "KNN",								GR_NODE,	false,	false,	0.0,	0,	"#/cell",			"number of IKK molecules" },
	{ "meanNFkB",							GR_NODE,	false,	false,	0.0,	0,	"#/cell",			"avearge number of total NFkB molecules" },
	{ "ka",									GR_NODE,	false,	false,	0.0,	0,	"1/s",				"IKKK activation rate" },
	{ "ki",									GR_NODE,	false,	false,	0.0,	0,	"1/s",				"IKKK inactivation rate" },
	{ "k1",									GR_NODE,	false,	false,	0.0,	0,	"1/s",				"IKKn activation rate" },
	{ "kA20",								GR_NODE,	false,	false,	0.0,	0,	"#/cell",			"Michaelis coeff. in TNFR activity attenuation" },
	{ "k2",									GR_NODE,	false,	false,	0.0,	0,	"#/cell",			"Michaelis coeff. in IKKa inactivation" },
	{ "k3",									GR_NODE,	false,	false,	0.0,	0,	"1/s",				"IKKn inactivation rate" },
	{ "k4",									GR_NODE,	false,	false,	0.0,	0,	"1/s",				"IKKi->IKKii and IKKii->IKKn transormation" },
	{ "q1",									GR_NODE,	false,	false,	0.0,	0,	"1/s",				"NF-kB binding at A20 and IkB gene promoters" },
	{ "q2",									GR_NODE,	false,	false,	0.0,	0,	"1/s",				"IkB inducible NF-kB detaching from A20 and IkB genes" },
	{ "c1",									GR_NODE,	false,	false,	0.0,	0,	"1/s",				"inducible A20 and IkB mRNA synthesis" },
	{ "c3",									GR_NODE,	false,	false,	0.0,	0,	"1/s",				"A20 and IkB mRNA degradation" },
	{ "c4",									GR_NODE,	false,	false,	0.0,	0,	"1/s",				"A20 and IkB traslation" },
	{ "c5",									GR_NODE,	false,	false,	0.0,	0,	"1/s",				"A20 degradation rate" },
	{ "a1",									GR_NODE,	false,	false,	0.0,	0,	"1/s",				"IkB association NF-kB" },
	{ "a2",									GR_NODE,	false,	false,	0.0,	0,	"1/s",				"IkB phosphorylation" },
	{ "a3",									GR_NODE,	false,	false,	0.0,	0,	"1/s",				"IkB phosphorylation in IkB/NF-kB complexes" },
	{ "tp",									GR_NODE,	false,	false,	0.0,	0,	"1/s",				"degradation of phosphorylated IkB" },
	{ "c5a",								GR_NODE,	false,	false,	0.0,	0,	"1/s",				"spontaneous IkB degradation" },
	{ "c6a",								GR_NODE,	false,	false,	0.0,	0,	"1/s",				"spontaneous IkB degradation in IkB/NF-kB complexes" },
	{ "i1",									GR_NODE,	false,	false,	0.0,	0,	"1/s",				"NF-kB nuclear import" },
	{ "e2a",								GR_NODE,	false,	false,	0.0,	0,	"1/s",				"IkB/NF-kB nuclear export" },
	{ "i1a",								GR_NODE,	false,	false,	0.0,	0,	"1/s",				"IkB nuclear import" },
	{ "e1a",								GR_NODE,	false,	false,	0.0,	0,	"1/s",				"IkB nuclear export" },
	{ "q1r",								GR_NODE,	false,	false,	0.0,	0,	"1/s",				"NF-kB binding at reporter gene promoter" },
	{ "q2r",								GR_NODE,	false,	false,	0.0,	0,	"1/s",				"IkB inducible NF-kB detaching from reporter gene" },
	{ "q2rr",								GR_NODE,	false,	false,	0.0,	0,	"1/s",				"spontaneous NF-kB detaching from reporter gene" },
	{ "c1r",								GR_NODE,	false,	false,	0.0,	0,	"1/s",				"inducible reporter mRNA synthesis" },
	{ "epsilon1",							GR_NODE,	false,	false,	0.0,	0,	"-"	,				"ratio for mRNA synthesis: NF-kB independent / NF-kB dependent" },
	{ "epsilon2",							GR_NODE,	false,	false,	0.0,	0,	"-"	,				"ratio for NF-kB dependent mRNA synthesis: resting Mac / infected Mac" },
	{ "c3rChem",							GR_NODE,	false,	false,	0.0,	0,	"1/s",				"chemokine mRNA degradation rate" },
	{ "c4Chem",								GR_NODE,	false,	false,	0.0,	0,	"1/s",				"chemokine translation" },
	{ "c5Chem",								GR_NODE,	false,	false,	0.0,	0,	"1/s",				"intracellualr chemokine degradation rate" },
	{ "e3Chem",								GR_NODE,	false,	false,	0.0,	0,	"1/s",				"chemokine export rate" },
	{ "c3rTNF",								GR_NODE,	false,	false,	0.0,	0,	"1/s",				"TNF mRNA degradation rate" },
	{ "c4TNF",								GR_NODE,	false,	false,	0.0,	0,	"1/s",				"TNF translation" },
	{ "c5TNF",								GR_NODE,	false,	false,	0.0,	0,	"1/s",				"intracellualr TNF degradation rate" },
	{ "e3TNF",								GR_NODE,	false,	false,	0.0,	0,	"1/s",				"TNF export rate" },
	{ "c1rrACT",							GR_NODE,	false,	false,	0.0,	0,	"1/s",				"mac-activation molecule mRNA constitutive synthesis" },
	{ "c3rACT",								GR_NODE,	false,	false,	0.0,	0,	"1/s",				"mac-activation molecule mRNA degradation rate" },
	{ "c4ACT",								GR_NODE,	false,	false,	0.0,	0,	"1/s",				"mac-activation molecule translation" },
	{ "c5ACT",								GR_NODE,	false,	false,	0.0,	0,	"1/s",				"mac-activation molecule degradation rate" },
	{ "actThreshod",						GR_NODE,	false,	false,	0.0,	0,	"-"	,				"ACT threshold for Mac activation" },
	{ "activationRate",						GR_NODE,	false,	false,	0.0,	0,	"1/s",				"mac activation rate constant after ACT threshold is met" },
	{ "c1rrIAP",							GR_NODE,	false,	false,	0.0,	0,	"1/s",				"IAP mRNA constitutive synthesis" },
	{ "c3rIAP",								GR_NODE,	false,	false,	0.0,	0,	"1/s",				"IAP mRNA degradation rate" },
	{ "c4IAP",								GR_NODE,	false,	false,	0.0,	0,	"1/s",				"IAP translation" },
	{ "c5IAP",								GR_NODE,	false,	false,	0.0,	0,	"1/s",				"IAP degradation rate" },
