...
typedef enum
{
  ...
  PARAM_MAC_THRESHOLD_ICOS,
  PARAM_MAC_HALF_SAT_TNF,
  PARAM_MAC_HALF_SAT_CHEMOKINE,
  PARAM_MAC_MAX_RECRUITMENT,
  PARAM_MAC_THRESHOLD_CHEMOKINE_RECRUITMENT,
  PARAM_MAC_THRESHOLD_TNF_RECRUITMENT,
  PARAM_MAC_STAT1_ACTIVATION_TIME,
  PARAM_MAC_NFKB_ACTIVATION_TIME,
  PARAM_TCELL_MTB_RECRUITMENT_THRESHOLD,
  PARAM_TCELL_PROB_RECRUITMENT,
  PARAM_TCELL_PROB_MOVE_TO_MAC,
  PARAM_TCELL_PROB_MOVE_TO_TCELL,
  PARAM_TCELL_MOVEMENT_BONUSFACTOR,
  PARAM_TGAM_HALF_SAT_TNF,
  PARAM_TGAM_HALF_SAT_CHEMOKINE,
  PARAM_TGAM_MAX_RECRUITMENT,
  PARAM_TGAM_PROB_APOPTOSIS_FAS_FASL,
  PARAM_TGAM_THRESHOLD_RECRUITMENT,
  PARAM_TGAM_PROB_RECRUITMENT,
  PARAM_TGAM_THRESHOLD_EXT_MTB,
  PARAM_TGAM_PROB_ANTIGEN_PRESENTATION,
  PARAM_TGAM_RATE_TGFB,
  PARAM_TGAM_RATE_ICOS,
  PARAM_TGAM_RATE_AGSTIM,
  PARAM_TGAM_THRESHOLD_CHEMOKINE_RECRUITMENT,
  PARAM_TGAM_THRESHOLD_TNF_RECRUITMENT,
  PARAM_TCYT_THRESHOLD_RECRUITMENT,
  PARAM_TCYT_PROB_RECRUITMENT,
  PARAM_TCYT_PROB_KILL_MAC,
  PARAM_TCYT_PROB_KILL_MAC_CLEANLY,
  PARAM_TCYT_MAX_RECRUITMENT,
  PARAM_TCYT_HALF_SAT_TNF,
  PARAM_TCYT_HALF_SAT_CHEMOKINE,
  PARAM_TCYT_THRESHOLD_CHEMOKINE_RECRUITMENT,
  PARAM_TCYT_THRESHOLD_TNF_RECRUITMENT,
  PARAM_TREG_THRESHOLD_RECRUITMENT,
  PARAM_TREG_PROB_RECRUITMENT,
  PARAM_TREG_PROB_DEACTIVATE,
  PARAM_TREG_DEACTIVATE_SLOPE,
  PARAM_TREG_DEACTIVATE_INTERCEPT,
  PARAM_TREG_MAX_RECRUITMENT,
  PARAM_TREG_HALF_SAT_TNF,
  PARAM_TREG_HALF_SAT_CHEMOKINE,
  PARAM_TREG_THRESHOLD_CHEMOKINE_RECRUITMENT,
  PARAM_TREG_THRESHOLD_TNF_RECRUITMENT,
  PARAM_INTMTB_GROWTH_RATE,
  PARAM_INTMTB_GROWTH_RATE_MIN,
  PARAM_INTMTB_GROWTH_RATE_MAX,
  PARAM_INTMTB_GROWTH_RATE_FACTOR_POST_ADAPTIVE,
  PARAM_INTMTB_GROWTH_RATE_FACTOR_DELAY,
  PARAM_EXTMTB_GROWTH_RATE,
  PARAM_EXTMTB_GROWTH_RATE_MIN,
  PARAM_EXTMTB_GROWTH_RATE_MAX,
  PARAM_EXTMTB_UPPER_BOUND,
  PARAM_EXTMTB_CASEATED_DEATH_RATE,
  PARAM_MTB_STOPPING_THRESHOLD,
  PARAM_MTB_STOPPING_THRESHOLD2,
  PARAM_muMDC_LN,
  PARAM_muN4,
  PARAM_k13,
  PARAM_hs13,
...
typedef enum
{
  ...
  PARAM_GR_NR_KILLINGS_FOR_CASEATION,
    ...
    // Int type Vascular Parameters
    PARAM_GR_VASCULAR_DOSE_START_TIME,
    //PARAM_GR_VASCULAR_IL10_DOSE_INTERVAL,
    //PARAM_GR_VASCULAR_TNF_DOSE_INTERVAL,
    PARAM_GR_VASCULAR_INH_DOSE_INTERVAL,
    // End of vascular parameters
  ...
  PARAM_TCELL_LYMPH_PROXY_SCALING_START,
  PARAM_TCELL_LYMPH_PROXY_FACTOR_TIME_START,
  PARAM_TCELL_LYMPH_PROXY_FACTOR_TIME_END,
  PARAM_TCELL_LYMPH_PROXY_FACTOR_TIME_NONLINEAR_END,
  PARAM_TCELL_LYMPH_PROXY_MTB_THRESHOLD,
  ...
  PARAM_MTB_STOPPING_TIME_STEP2,
  PARAM_AREA_CELL_DENSITY_STOPPING_THRESHOLD,
  PARAM_AREA_CELL_DENSITY_STOPPING_THRESHOLD2,
  PARAM_AREA_CELL_DENSITY_STOPPING_TIME_STEP,
  PARAM_AREA_CELL_DENSITY_STOPPING_TIME_STEP2,
  PARAM_NFKBODE_EN,
  PARAM_TNFODE_EN,
  PARAM_IL10ODE_EN,
