...
typedef enum {
	...
	PARAM_TCELL_LYMPH_PROXY_NONLINEAR_M,
	PARAM_TCELL_LYMPH_PROXY_NONLINEAR_B,
...
typedef enum {
	...
	PARAM_TCELL_LYMPH_PROXY_NONLINEAR_TIME_START,
	PARAM_TCELL_LYMPH_PROXY_NONLINEAR_TIME_FULL,
