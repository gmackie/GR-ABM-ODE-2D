...
void RecruitmentLnODEPure::solveODE(const int, const Stats&, Stats& stats)
{
  ...
  static const double muMDC_LN= _PARAM(_muMDC_LN);
  static const double init_n4 = _PARAM(_initN4);
  static const double init_n8 = _PARAM(_initN8);
  static const double muN4    = _PARAM(_muN4);
  static const double k13     = _PARAM(_k13);
  static const double hs13    = _PARAM(_hs13);
  static const double k14     = _PARAM(_k14);
  static const double k15     = _PARAM(_k15);
  static const double rho2    = _PARAM(_rho2);
  static const double k20a    = _PARAM(_k20a);
  static const double hs20a   = _PARAM(_hs20a);
  static const double csi1    = _PARAM(_csi1);
  static const double csi1a   = _PARAM(_csi1a);
  static const double muN8    = _PARAM(_muN8);
  static const double wT80    = _PARAM(_wT80);
  static const double k16     = _PARAM(_k16);
  static const double hs16    = _PARAM(_hs16);
  static const double k17     = _PARAM(_k17);
  static const double hs17    = _PARAM(_hs17);
  static const double k18     = _PARAM(_k18);
  static const double rho3    = _PARAM(_rho3);
  static const double k24a    = _PARAM(_k24a);
  static const double hs24a   = _PARAM(_hs24a);
  static const double csi2    = _PARAM(_csi2);
  static const double csi2a   = _PARAM(_csi2a);
  static const double csi2b   = _PARAM(_csi2b);
  static const double scaling = _PARAM(_scaling);
  static const double m       = _PARAM(_m);
