...
void Tgam::secrete(GrGrid& grid, bool tnfrDynamics, bool, bool tnfDepletion)
{
...
void Tgam::computeNextState(const int time, GrGrid& grid, GrStat& stats, bool tnfrDynamics, bool)
{
	GridCell& cell = grid(_row, _col);
