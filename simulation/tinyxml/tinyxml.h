...
public:
	...
	*/
	...
	/// QueryUnsignedIntValue examines the value string. See QueryIntValue().
	int QueryUnsignedIntValue( unsigned int* ival ) const;
...
public:
	...
	*/	
	...
	/// QueryUnsignedIntAttribute examines the attribute - see QueryIntAttribute().
	int QueryUnsignedIntAttribute( const char* name, unsigned int* ival ) const;
	...
	*/
	...
	int QueryUnsignedIntAttribute( const std::string& name, unsigned int* _value ) const;
